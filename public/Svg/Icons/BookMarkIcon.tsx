...
export  function BookMarkIcon({isDark,isSmall}:Props) {
  return (
  <svg height={isSmall ? '19px' : "21px"} width={isSmall ? '15px' : "16px"} fill="none" viewBox="0 0 16 21" xmlns="http://www.w3.org/2000/svg">
